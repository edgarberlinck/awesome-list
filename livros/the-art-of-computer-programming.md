...
**Language:** English
**Difficulty:** Advanced
**Topics:** algorithms, computer-science, mathematics, programming

## Links

- [Acessar](https://www-cs-faculty.stanford.edu/~knuth/taocp.html)

## Descrição

Considerada uma das obras mais importantes da história da computação,
apresenta um estudo profundo sobre algoritmos, estruturas de dados e análise
